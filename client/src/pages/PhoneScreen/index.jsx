...
const PhoneScreen = () => {
  ...
  const handleKeyPress = (value) => handlePress(value);
  ...
  useEffect(() => {
    ...
    tl.fromTo(".phone-page-header", { opacity: 0, y: -20 }, { opacity: 1, y: 0, duration: 0.5 })
      .fromTo(
        ".phone-shell",
        { y: -55, opacity: 0 },
      ...
      .fromTo(".phone-display", { opacity: 0, scaleX: 0.85 }, { opacity: 1, scaleX: 1, duration: 0.4 }, "-=0.25")
      .fromTo(
        ".key-btn",
        { scale: 0, opacity: 0 },
        { scale: 1, opacity: 1, stagger: { amount: 0.45, from: "start" }, ease: "back.out(1.8)", duration: 0.3 },
        "-=0.2"
      )
      .fromTo(
        ".delete-btn, .call-btn",
  ...
  return (
    <div className="phone-page">
      <div className="phone-page-header">
        <h2 className="phone-page-title">Hail the Captain</h2>
        <div className="phone-page-rope" />
        <p className="phone-page-desc">
          I build for mobile. Ring the bell if you need a hand on deck.
        </p>
      </div>
